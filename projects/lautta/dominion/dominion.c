...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
      //Return the result of the new Adventurer function call
      return playAdventurer(drawntreasure, state, currentPlayer, cardDrawn, temphand, z);

    case council_room:
      //Return the result of the new Council Room function call
    ...
    case smithy:
      //Return the result of the new Smithy function call
      return playSmithy(currentPlayer, state, handPos);

    case village:
      //Return the result of the new Village function call
    ...
    case great_hall:
      //Return the result of the new Great Hall function call
